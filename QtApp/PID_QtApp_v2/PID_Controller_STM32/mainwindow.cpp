    ...
    , ui(new Ui::MainWindow)
{
    ...
    */
    ...
    ui->customPlot->addGraph(); // red line
    ui->customPlot->graph(2)->setPen(QPen(QColor(0, 140, 120)));

    QSharedPointer<QCPAxisTickerTime> timeTicker(new QCPAxisTickerTime);
    timeTicker->setTimeFormat("%s:%ms");
...
void MainWindow::realtimeDataSlot()
{
  ...
  if(key-lastAxisKey > 300){
      ui->customPlot->xAxis->setRange(key, 300+key);
      lastAxisKey = key;
  }
